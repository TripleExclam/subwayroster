...
<body>
	...
	<div class="container-contact100" style="background-image: url('bg-01.jpg');">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="process.php" method="post">
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid password is required: abcdefg1213">
		...
		<span class="contact100-more">
			Not registered? 
			<a class="contact100-more" href="create.php">Create an account</a>
		</span>
